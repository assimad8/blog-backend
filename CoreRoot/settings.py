...
SECRET_KEY = 'django-insecure-$kfo_oyx)feyus-*lg$kw2(vc#8tw*=e)7_@t7==j1z!^b#zg4'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(hours=23),  # Set access token lifetime (e.g., 1 hour)
